...
**Objetivo:**  
Criar os **endpoint /api/login** com base na Codigo base para o /api/login
...
## 🌐 Endpoints esperados:
- Utilizar o Endpoint Base `/api/login` abaixo como base obrigatória da lógica de login de usuario 
