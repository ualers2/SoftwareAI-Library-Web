...
from Agents.Code.DevOps.RequirementsTxt.Integration import CodeRequirementstxtAgent
...
def CodeDockerComposeAgent(session_id, appcompany):
    ...
    agent_, handoff_obj_CodeRequirementstxtAgent = CodeRequirementstxtAgent("", "")
