...
from Agents.Code.ProjectManager.Documentation.Technich.Integration import CodeDocumentationTechnichAgent
...
def CodeDocumentationStaticjsAgent(session_id, appcompany):
